...
* Vector of p-values for DC result reported in Rosenbaum et al. 2024: 0.043, 0.838 (from Table 4c, 'Test of theories: marginal effects and p-value' panel)
* Vector of p-values for AR result reported in Rosenbaum et al. 2024: 0.153, 0.081, 0.354, 0.451 (from Table 4c, 'Test of theories: marginal effects and p-value' panel)
